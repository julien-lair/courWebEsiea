...
return array(
	...
	'pre_restore_message' => __("You will now be taken to the site's dashboard, to allow you to choose restoration options.", 'updraftcentral').' '.__("Note that depending upon what you restore, and the state of the site when the backup was taken, restoring may cause your UpdraftCentral connection to be broken.", 'updraftcentral').' '.__("In that case, you will need to re-create it after restoring.", 'updraftcentral'),
	...
	'directory_field_desc' => __('If you are not sure what this option is for, then you will not want it, and should turn it off.', 'updraftcentral').' '.__('If using it, then enter the directory path below.', 'updraftcentral').' '.__('Be careful what you enter - if you enter / then it really will try to create a zip containing your entire webserver.', 'updraftcentral'),
	'manual_auth_result' => __('Manual Authentication', 'updraftcentral'),
);
