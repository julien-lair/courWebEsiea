...
return array(
	'site_not_connected' => __('This site has not been connected to UpdraftVault.', 'updraftcentral').' '.__('To do this, go to the "Backups" panel.', 'updraftcentral'),
	'general_error_response' => __('There appears to be a problem when processing your request.', 'updraftcentral').' '.__('Please refer to the following response: %s', 'updraftcentral'),
	'unexpected_format' => __('Received response, but it was not in the expected format.', 'updraftcentral').' '.__('Please refer to the following response: %s', 'updraftcentral'),
	'unexpected_http_response' => __('Unexpected HTTP response code.', 'updraftcentral').' '.__('The server or database may be down or is unable to process your request at the moment.', 'updraftcentral').' '.__('Please refer to the following response: %s', 'updraftcentral'),
	'result_not_understood' => __('wp_remote_post returned a result that was not understood.', 'updraftcentral').' '.__('Please refer to the following response: %s', 'updraftcentral'),
	'objects_not_loaded' => __('Could not load objects.', 'updraftcentral').' '.__('Please refer to the following response: %s', 'updraftcentral'),
