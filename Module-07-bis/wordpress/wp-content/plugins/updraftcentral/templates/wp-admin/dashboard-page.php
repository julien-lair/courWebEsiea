...
<div style="width:800px;">
	...
	<p><?php echo sprintf(esc_html__('UpdraftCentral runs on the front-end of your site.', 'updraftcentral').' '.esc_html__('To get started, you must create a front-end page for your site, to contain the dashboard.', 'updraftcentral').' '.esc_html__('i.e. Go to %s.', 'updraftcentral'), '<a href="'.esc_url(admin_url('post-new.php?post_type=page')).'">'.sprintf(esc_html__('Pages %s Add New', 'updraftcentral'), esc_html('->')).'</a>');?></p>
